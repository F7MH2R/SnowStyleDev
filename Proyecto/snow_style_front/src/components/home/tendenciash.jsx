...
const TrendingSectionH = () => {
    ...
    const trendingItems = [
      { id: 1, imageUrl: "https://i.ibb.co/dWjJ7Zz/hombres-imagen1.jpg", title: "Sudaderas" },
      { id: 2, imageUrl: "https://i.ibb.co/VVdjZnk/hombres-imagen2.webp", title: "Camisas" },
      { id: 3, imageUrl: "https://i.ibb.co/vZktKXh/hombres-imagen3.webp", title: "Pantalones" },
      { id: 4, imageUrl: "https://i.ibb.co/2SNvfJX/hombres-imagen4.jpg", title: "Abrigos" },
    ];
