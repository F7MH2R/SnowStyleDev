      ...
      <div style={styles.detalleProductoContent}>
        ...
        <div style={styles.caracteristicasContainer}>
          ...
          <div style={styles.imagenesContainer1}>
            <img src={s1} alt="Imagen 1" style={styles.imagenMiniatura} />
            <img src={s2} alt="Imagen 2" style={styles.imagenMiniatura} />
          </div>
          <p style={styles.caracteristicas}>Precio: $39.95</p>
        </div>
        <h1 style={styles.titulo}>Tallas Disponibles</h1>
        <div style={styles.botonesContainer}>
          <button style={styles.btnPequeno}>S</button>
          <button style={styles.btnPequeno}>M</button>
          <button style={styles.btnPequeno}>L</button>
          <button style={styles.btnPequeno}>XL</button>
          <button style={styles.btnPequeno}>XXL</button>
        </div>
        ...
        <button style={styles.btnAgregarCarrito}>Agregar al carrito</button>
